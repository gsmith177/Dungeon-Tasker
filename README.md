This is a basic dnd compation app that will do the following:

1: Have integrated controlls for music (uses spotify to shuffle playlists for combat, puzzles, and exploration)

2: Have all the dnd 5e rules (the players handbook, monster manual, and dungen master’s handbook) and make them searchable with an existing ai pipeline. For example, i could ask the ai “how does damage work?” and it can search the three texts and respond with the rules and an explanation of how they work.

3: encounter builder- a way for me to build combat encounters and puzzles on the fly, automatically comes up with random encounters that are leveled properly for the party.

4: a way to record audio so i can review and recap previous sessions.
